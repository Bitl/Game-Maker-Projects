 ...
 * 
 * File: ep_RailJoint_IntegrateVelocity.h
 * Applies forces every step for rail joints.
 * Included in ep_World_IntegrateVelocity.cpp.
 */

#ifndef EP_RAILJOINT_INTEGRATEVELOCITY_H
#define EP_RAILJOINT_INTEGRATEVELOCITY_H

#include "ExtremePhysics.h"

EP_FORCEINLINE void ep_RailJoint::IntegrateVelocity() {
...
#endif // EP_RAILJOINT_INTEGRATEVELOCITY_H
